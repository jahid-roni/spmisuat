<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCMessageInfo.ascx.cs" Inherits="SBM_WebUI.UI.UC.UCMessageInfo" %>
<style type="text/css">
    .auto-style1 {
        width: 65px;
    }
...
<div id="MDMessage" class="MDClass" runat="server">
    <table width="470" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
            <td>
                <div class="MDBody" style="height: 525px; overflow: auto;">
...
<script language="javascript" type="text/javascript">
    function MsgPopupHide() {
        hideModal('ctl00_cphDet_UCMessageInfo_MDMessage');
        return true;
    }
    ...
    function MsgPopupReturnTrue(vData) {
        ...
        window.scroll(0, 0);
        showModal("ctl00_cphDet_UCMessageInfo_MDMessage");
        return true;
    }
</script>
