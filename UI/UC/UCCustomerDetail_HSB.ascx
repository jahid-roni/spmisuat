<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCustomerDetail_HSB.ascx.cs"
    Inherits="SBM_WebUI.UI.UC.UCCustomerDetail_HSB" %>
<div id="MDCustomerDetail" class="MDClass" runat="server">
                            ...
                            <fieldset>
                                ...
                                <table width="850" align="center" class="tableBody" border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="fieldLeft">
                                                <asp:TextBox ID="txtMasterNo" TabIndex="31" MaxLength="9" runat="server" CssClass="textInput"
                                            ...
                                            <div class="searchButton">
                                                <asp:Button ID="btnMasterLoad" OnClick="btnMasterLoad_Click" runat="server" CssClass="ButtonAsh"
                                                    Text="Search" TabIndex="32" Width="60px" />
                                                <asp:Button ID="btnNew"  runat="server" CssClass="ButtonAsh" Width="60px" 
                                                    Text="New" TabIndex="32" OnClick="btnNew_Click" />
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" valign="top">TIN No</td>
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:TextBox ID="txtTINNo" runat="server" CssClass="textInput" onblur="blurActiveInputWithObj(this)"
                                                    onfocus="highlightActiveInputWithObj(this)" Width="240px" MaxLength="100" TabIndex="34"></asp:TextBox>
                                            </div>
                                            <div class="errorIcon">
                                                *
                            ...
                            <fieldset>
                                ...
                                <table width="850" align="center" class="tableBody" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:DropDownList ID="ddlNationalityCountry" runat="server" AutoPostBack="true"  SkinID="ddlSmall" TabIndex="39" Height="18px" Width="240px">
                                        ...
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:DropDownList ID="ddlResidentCountry" runat="server" AutoPostBack="true" SkinID="ddlSmall" TabIndex="39" Width="240px">
                                                    <asp:ListItem Text="BANGLADESH" Value="BANGLADESH"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="fieldLeft">
                                                <asp:TextBox ID="txtNationality" runat="server" CssClass="textInput" onblur="blurActiveInputWithObj(this)"
                                                    Text="Bangladeshi" onfocus="highlightActiveInputWithObj(this)" Width="100px" Visible="false" 
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            ...
                                            <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:DropDownList ID="ddlNationalIDCountry" runat="server" AutoPostBack="true" SkinID="ddlSmall" TabIndex="39" Height="18px" Width="200px" Visible="false">
                                                    <asp:ListItem Text="Bangladesh" Value="Bangladesh"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </td>
...
<tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:DropDownList ID="ddlDateofBirthCountry" runat="server" AutoPostBack="true"  SkinID="ddlSmall" TabIndex="39" Height="18px" Width="240px">
                                                    <asp:ListItem Text="Bangladesh" Value="Bangladesh"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:TextBox ID="txtBirthPlace" runat="server" CssClass="textInput" MaxLength="50" onblur="blurActiveInputWithObj(this)" onfocus="highlightActiveInputWithObj(this)" TabIndex="42" Width="200px"></asp:TextBox>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:DropDownList ID="ddlPassportCountry" runat="server" AutoPostBack="true" SkinID="ddlSmall" TabIndex="39" Height="18px" Width="240px">
                                        ...
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:TextBox ID="txtPassportIssueAt" runat="server" CssClass="textInput" MaxLength="50" onblur="blurActiveInputWithObj(this)" onfocus="highlightActiveInputWithObj(this)" TabIndex="42" Width="200px"></asp:TextBox>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" align="midle">
                                            <div class="fieldLeft">
                                                <asp:DropDownList ID="ddlBirthCertNoCountry" runat="server" AutoPostBack="true" SkinID="ddlSmall" TabIndex="39" Height="18px" Width="240px">
                                                    <asp:ListItem Text="Bangladesh" Value="M"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                        <td valign="top">
                                            <div class="fieldLeft">
                                                <asp:TextBox ID="txtBirthCertNoIssueAt" runat="server" CssClass="textInput" MaxLength="50" onblur="blurActiveInputWithObj(this)" onfocus="highlightActiveInputWithObj(this)" TabIndex="42" Width="200px"></asp:TextBox>
                                            </div>
