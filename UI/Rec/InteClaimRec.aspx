<%@ Page Language="C#" MasterPageFile="~/mp/site.master" AutoEventWireup="true" CodeBehind="InteClaimRec.aspx.cs"
    Inherits="SBM_WebUI.mp.InteClaimRec" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDet" runat="server">
    ...
    <fieldset runat="server" id="fsList">
        <legend runat="server" id="lgText">Unapproved Interest Reconciliation List</legend>
    ...
    <fieldset>
        <asp:UpdatePanel runat="server" ID="UpdatePanel2">
            <ContentTemplate>
                <asp:HiddenField ID="hdnInterestReimburseTransNo" runat="server" />
                <asp:HiddenField ID="hdnInterestClaimTransNo" runat="server" />
                <asp:HiddenField ID="hdnIntPayTransNo" runat="server" />
                ...
                <table width="95%" align="center" class="tableBody" cellpadding="3" cellspacing="3"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtInterest" Width="100px" CssClass="textInputDisabled" runat="server"
                                ReadOnly="true"></asp:TextBox>
                        </td>
                        ...
                        <td align="right" valign="top">
                            ...
                            &nbsp;<asp:Button runat="server" ID="btnAdd" Width="50px" Text="Add" CssClass="ButtonAsh"
                                OnClientClick="return AddInterestCalimDetail()" OnClick="btnAdd_Click" />
                        </td>
                        <%--<td>
                    ...
                    <%--                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtReconInterest" CssClass="textInput" Width="100px" runat="server"
                                onblur="blurActiveInputWithObj(this)" onfocus="highlightActiveInputWithObj(this)"></asp:TextBox>
                        </td>
                        <td align="right" valign="top">
                            Recon Remuneration
...
--%>
                                ...
                                <asp:GridView Style="width: 98%" ID="gvClaim" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Remove" HeaderStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Button ID="btnRemove" Text="Remove" CssClass="ButtonAsh" runat="server" OnClientClick="return CheckForDelete('this Interest Claim detail?')" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="ClaimAmount" HeaderText="Outstanding" />
                                        <asp:BoundField DataField="ReconAmount" HeaderText="Received" />
                                        <%--<asp:BoundField DataField="ReconInterest" HeaderText="Recon Interest" />--%>
                                        ...
                                        <asp:BoundField DataField="InterestClaimTransNo" HeaderText="ClaimTransNo" Visible="false" />
                                    </Columns>
                                    <EmptyDataTemplate>
                                        No record found
                                    </EmptyDataTemplate>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:TextBox ID="txtTotInterest" Width="100px" CssClass="textInputDisabled" ReadOnly="true"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTotRecRem" Width="100px" CssClass="textInputDisabled" ReadOnly="true"
                                runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                ...
                <table width="95%" align="center" class="tableBody" cellpadding="3" cellspacing="3"
                    ...
                    <tr>
                        <td colspan="8" align="right">
                            ...
                            <asp:TextBox Width="100px" ID="txtIntTransNo" CssClass="textInputDisabled" Visible="false" runat="server"></asp:TextBox>
                            ...
                            &nbsp;<asp:Button runat="server" ID="btnResetDetails" Text="Reset" 
                                ...
                                OnClientClick="return AddInterestDetail()" 
                                OnClick="btnResetDetails_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="7">
                            Interest Payment Details<br />
                            <div style="height: 200px; width: 700px; overflow: auto;">
                                <asp:GridView Style="width: 98%" ID="gvIntClaimDetail" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Remove" HeaderStyle-Width="5%">
                                            <ItemTemplate>
                                                <asp:Button ID="btnRemove_D" Text="Remove" CssClass="ButtonAsh" runat="server" OnClientClick="return CheckForDelete('this Interest Claim detail?')" />
                                            </ItemTemplate>
                                            <HeaderStyle Width="5%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="ClaimAmount" HeaderText="Outstanding" />
                                        <asp:BoundField DataField="ReconAmount" HeaderText="Received" />
                                        <asp:BoundField DataField="IntPayTransNo" HeaderText="IntPayTransNo" Visible="false" />
                                        <asp:BoundField DataField="InterestClaimTransNo" HeaderText="InterestClaimTransNo"
                                            Visible="false" />
                                    </Columns>
                                    <EmptyDataTemplate>
                                        No record found
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <asp:TextBox ID="txtNoOfInterestPay" Width="100px" CssClass="textInputDisabled" ReadOnly="true"
                                runat="server"></asp:TextBox>
                        </td>
                        <td align="right">
...
////            $('input[id*=txtCovRateToBC]').keypress(function(e) { return floatNumber(e); });
            //$('input[id*=txtReconInterest]').keypress(function(e) { return floatNumber(e); });
        ...
        function AddInterestCalimDetail() {
            var sErrorList = "";
...
//            sErrorList += RequiredData('<%=txtCovRateToBC.ClientID %>', 'TextBox', "Coversin Rate To BC cannot be empty!");
            sErrorList += RequiredData('<%=txtBBAmount.ClientID %>', 'TextBox', "BB Amount cannot be empty!");

            var rowsGvClaim = $("#<%=gvClaim.ClientID %> tr").length;
            if (rowsGvClaim == 1 || rowsGvClaim == 0) {
                sErrorList += "<li>Interest Claim Details grid cannot be empty</li>";
            }
//            if (Number(document.getElementById('<%= txtBBAmount.ClientID %>').value) <= 0)
//            {
//                sErrorList += "<li>BB Amount cannot be less then or zero!</li>";
//            }
        ...
        function Delete() {
            var divErrorPanel = document.getElementById('divErrorPanel');
            var hdIntReimTransNo = document.getElementById('<%=hdnInterestReimburseTransNo.ClientID %>');
            if (hdIntReimTransNo.value != "") {
                divErrorPanel.style.display = "none";
                if (CheckForDelete('this Interest Claim Reconciliation Data?')) {
                ...
                // show error divErrorList                
                var errorList = document.getElementById('divErrorList');
                errorList.innerHTML = "<ul><li>Interest Claim Reconciliation has not been selected</li></ul>";
                divErrorPanel.style.display = "block";
                window.scroll(0, 0);
                return false;
                // end of show error divErroList
