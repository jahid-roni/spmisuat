...
{
    public partial class RptLastLogon : System.Web.UI.Page
    {
        ...
        protected void btnPrintPreview_Click(object sender, EventArgs e)
        {
            ...
            if (oConfig != null)
            {
                ...
                bool chkDate = chkUploadDataRange.Checked;

                oResult = rDal.LastLogonReport(sBankName, sBranchName, chkDate, dtToDate, dtFromDate, oConfig.BankCodeID, oConfig.DivisionID);
