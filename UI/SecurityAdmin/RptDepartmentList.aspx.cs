...
{
    public partial class RptDepartmentList : System.Web.UI.Page
    {
        ...
        protected void btnPrintPreview_Click(object sender, EventArgs e)
        {
            ...
            if (oConfig != null)
            {
                ...
                oResult = rDal.DipartmentListReport(sBankName, sBranchName, oConfig.BankCodeID, oConfig.DivisionID);
