<%@ Page Title="" Language="C#" MasterPageFile="~/mp/site.master" AutoEventWireup="true"
    CodeBehind="RptLastLogon.aspx.cs" Inherits="SBM_WebUI.mp.RptLastLogon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDet" runat="server">
    ...
    <fieldset>
        ...
        <table width="100%" align="center" class="tableBody" cellpadding="3" cellspacing="3"
            ...
            <tr>
                ...
                <td>
                    <div class="fieldLeft">
                        <asp:TextBox Width="160px" ID="txtBankName" CssClass="textInput" runat="server" onblur="blurActiveInputWithObj(this)"
    ...
    <fieldset>
        <legend>
            <asp:CheckBox runat="server" ID="chkUploadDataRange" Text="Upload Date Range" /></legend>
        <table width="100%" align="center" cellpadding="3" cellspacing="3" border="0">
            <tr>
                ...
                <td>
                    <div class="fieldLeft">
                        <asp:TextBox runat="server" CssClass="textInput" Width="150px" ID="txtFromDate" onblur="blurActiveInputWithObj(this)"
                ...
                <td>
                    <div class="fieldLeft">
                        <asp:TextBox runat="server" CssClass="textInput" Width="150px" ID="txtToDate" onblur="blurActiveInputWithObj(this)"
                            onfocus="highlightActiveInputWithObj(this)"></asp:TextBox></div>
                    <div class="errorIcon">
                        *</div>
                </td>
