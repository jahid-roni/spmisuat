<%@ Page Title="" Language="C#" MasterPageFile="~/mp/site.master" AutoEventWireup="true"
    CodeBehind="RptSecurityViolationLog.aspx.cs" Inherits="SBM_WebUI.mp.RptSecurityViolationLog" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function PrintValidation() {
            ...
            sErrorList += RequiredData('<%=txtReportOnDate.ClientID %>', 'TextBox', "Report On cannot be empty!");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDet" runat="server">
    ...
    <%-- Error --%>
    <fieldset>
        <legend>Security Violation Log Report</legend>
        <table width="100%" align="center" class="tableBody" cellpadding="3" cellspacing="3"
            ...
            <tr>
                ...
                <td colspan="3">
                    <div class="fieldLeft">
                        <asp:TextBox Width="160px" ID="txtReportOnDate" CssClass="textInput" runat="server"
                            onblur="blurActiveInputWithObj(this)" onfocus="highlightActiveInputWithObj(this)"></asp:TextBox>
                    </div>
                    <div class="errorIcon">
                        *</div>
