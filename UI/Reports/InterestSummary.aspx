<%@ Page Title="" Language="C#" MasterPageFile="~/mp/site.master" AutoEventWireup="true"
    CodeBehind="InterestSummary.aspx.cs" Inherits="SBM_WebUI.mp.InterestSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDet" runat="server">
    ...
    <fieldset>
        <legend>Interest Summary</legend>
            ...
            <tr>
                ...
                <td>
                    <asp:Button CssClass="ButtonAsh" runat="server" Text="Show Data" ID="btnShowData"
                        OnClientClick="return PrintValidation()" OnClick="btnShowData_Click"></asp:Button>
                </td>
            </tr>
            <tr>
                <td colspan="7">
