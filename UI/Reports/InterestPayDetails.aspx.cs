...
{
    public partial class InterestPayDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session[Constants.SES_USER_CONFIG] != null)
            {
                if (!Page.IsPostBack)
                {
                    ...
                    if (!chkPer.CheckPagePermission((Control)this.Page, oConfig, (int)Constants.PAGEINDEX_REPORT.INTEREST_PAYMENT_DETAILS))
                    {
        ...
        protected void btnPrintPreview_Click(object sender, EventArgs e)
        {
            ...
            if (oConfig != null)
            {
                ...
                oResult = rdal.InterestPayDetailsReport(sCurrency, sCheckList, dtFromDate, dtToDate, sRptType, oConfig.BankCodeID, oConfig.DivisionID, oConfig.BranchID);
                if (oResult.Status)
                {
