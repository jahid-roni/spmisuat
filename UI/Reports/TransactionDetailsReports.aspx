<%@ Page Title="" Language="C#" MasterPageFile="~/mp/site.master" AutoEventWireup="true"
    CodeBehind="TransactionDetailsReports.aspx.cs" Inherits="SBM_WebUI.mp.TransactionDetailsReports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function PrintValidation() {
            ...
            sErrorList += RequiredData('<%=ddlPayment.ClientID %>', 'DropDownList', "Payment Mode cannot be empty!");
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDet" runat="server">
    ...
    <fieldset>
        <legend>Transaction Details Reports</legend>
        <table width="85%" align="center" cellpadding="3" cellspacing="3" border="0">
            <tr>
                ...
                <td valign="top">
                    <div class="fieldLeft">
                        <asp:DropDownList runat="server" ID="ddlPayment" SkinID="ddlMedium">
                        </asp:DropDownList>
                    </div>
                    <div class="errorIcon">
                        *</div>
                    <br />
                    <br />
                    <asp:CheckBox runat="server" ID="chkForAllUser" Text="For All User" />
                </td>
                <td align="right" valign="top" rowspan="5">
                    SP Type
                </td>
                <td rowspan="5" valign="top">
                    <div style="height: 200px; width: 312px; overflow: auto;">
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:DropDownList runat="server" ID="ddlStatus" SkinID="ddlMedium">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
