<%@ Page Title="" Language="C#" MasterPageFile="~/mp/site.master" AutoEventWireup="true"
    CodeBehind="CommClaimSummary.aspx.cs" Inherits="SBM_WebUI.mp.CommClaimSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphDet" runat="server">
    ...
    <fieldset>
        <legend>Commission Claim Summary</legend>
        <table width="80%" align="center" cellpadding="3" cellspacing="3" border="0">
            <tr>
                ...
                <td valign="top">
                    <div class="fieldLeft">
                        <asp:TextBox runat="server" CssClass="textInput" Width="120px" ID="txtFromDate" onblur="blurActiveInputWithObj(this)"
            ...
            <tr>
                ...
                <td valign="top">
                    <div class="fieldLeft">
                        <asp:TextBox runat="server" CssClass="textInput" Width="120px" ID="txtToDate" onblur="blurActiveInputWithObj(this)"
                            onfocus="highlightActiveInputWithObj(this)"></asp:TextBox></div>
                    <div class="errorIcon">
                        *</div>
                </td>
