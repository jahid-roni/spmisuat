<%@ Page Title="" Language="C#" MasterPageFile="~/mp/site.master" AutoEventWireup="true"
    CodeBehind="LienRep.aspx.cs" Inherits="SBM_WebUI.mp.LienRep" %>
    ...
    <fieldset>
        ...
        <table width="95%" align="center" cellpadding="3" cellspacing="3" border="0">
            ...
            <tr>
                ...
                <td>
                    &nbsp;&nbsp;<asp:TextBox runat="server" CssClass="textInput" Width="130px" ID="txtFromDate"
            ...
            <tr>
                ...
                <td>
                    &nbsp;&nbsp;<asp:TextBox runat="server" CssClass="textInput" Width="130px" ID="txtToDate"
                        onblur="blurActiveInputWithObj(this)" onfocus="highlightActiveInputWithObj(this)"></asp:TextBox>
                </td>
            </tr>
        </table>
