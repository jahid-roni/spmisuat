...
{
    public partial class ACERegister : System.Web.UI.Page
    {
        ...
        protected void btnPrintPreview_Click(object sender, EventArgs e)
        {
            ...
            if (oConfig != null)
            {
                ...
                oResult = rdal.ACERegisterReport(sRptType, sCheckList, dtFromDate, dtToDate, oConfig.DivisionID, oConfig.BankCodeID);
                if (oResult.Status)
                {
