...
{
    public partial class StopPayRep : System.Web.UI.Page
    {
        ...
        protected void btnPrintPreview_Click(object sender, EventArgs e)
        {
            ...
            if (oConfig != null)
            {
                ...
                oResult = rdal.StopPaymentReport(sRptType, sCheckList, dtFromDate, dtToDate, sUserID, oConfig.BankCodeID, oConfig.DivisionID, oConfig.BranchID);
                if (oResult.Status)
                {
